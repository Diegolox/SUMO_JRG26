...
<table>
  <tr>
    ...
    <td valign="top">
      ...
      <p align="justify">
El servidor wifi tiene tres botones arriba del todo: START, STOP y RESET_MEF. Estos botones sirven para iniciar, parar o resetear la máquina de estados. Y para saber si lo hace bien y está en el estado correcto disponemos también de unos visualizadores que muestran el estado actual de la MEF. Tiene otros datos para hacer debug cómo la distancia con la que el robot ha transicionado de búsqueda o ataque, lo que nos servía para ver si el robot verdaderamente había visto el cono u otra cosa entre medias. También se pueden cambiar las constantes del control de velocidad en caso de que este esté desajustado. Al final del todo del servidor se puede ver que hay un montón de tiempos y velocidades que se pueden cambiar.
      </p>
    </td>
  </tr>
</table>
